...
/**
 * Allows for Movie and Admin Objects to be serialised and stored in a flat file
 * format (.txt) which then can be imported back as its respecitve objects
...
public class serialise {
	...
	/**
	 * Exports List of Movie Objects into a text file to be stored so that it can be
	 * then imported the next time the program is executed.
	 *
	...
	/**
	 * Exports List of Admin Objects into a text file to be stored so that it can be
	 * then imported the next time the program is executed.
	 *
	 * @param filename  to dictate which file it is serialising the objects to.
