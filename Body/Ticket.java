...
/**
 * Contains ticket information. Able to calculate ticket price
 * and display its own information.
 */
public class Ticket {
	/**
	 * The movie's title.
	 ...
	 * @param ageOfCust
	 * @param student
	 * @param preferredCreditAndLoyaltyCards
	 * @param dayOfWeek
	 * @param publicHolidayOrEve
	 * @param time
	 * @param seatId
	 */
	public Ticket(String movieTitle, boolean threeD, boolean blockbuster, String cinemaClass, int ageOfCust, boolean student, boolean preferredCreditAndLoyaltyCards,
	...
	/** 
	 * Return true if customer is student,
	 * false otherwise.
	...
	/** 
	 * Return true if customer has a preferred credit or loyalty card,
	 * false otherwise.
	 ...
	 * @param preferredCreditAndLoyaltyCards Whether customer has a preferred credit or loyalty card.
	 */
